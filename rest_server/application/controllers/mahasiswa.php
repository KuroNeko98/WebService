...
class Mahasiswa extends RestController {
    ...
    public function index_get()
    {
        ...
        if ( $id == null ) // ini buat ngecek udah ke isi apa belum 
        {
            ...
            $users = $this->db->get('mahasiswa')->result(); // ini fungsinya buat select semua data di table mahasiswa
        ...
        else
        {
            ...
            $users = $this->db->get('mahasiswa')->result(); // ini sama baris diatasnya fungsinya buat ngambil data ditable mahasiswa berdasarkan
